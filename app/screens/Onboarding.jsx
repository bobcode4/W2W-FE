...
const Onboarding = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      title: 'Ship',
      description: 'Track your goods right from when it is shipped till it reaches you all with our app.',
    },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        ...
        {/* Next Button */}
        <Button title={activeIndex === 2 ? 'Create an Account' : 'Next'} onPress={handleNext} />
      </View>
    </View>
  );
};
